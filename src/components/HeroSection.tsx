...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-grid pt-navbar-fix pt-20 md:pt-0"
    >
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(187, 94%, 48%) 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      <main id="main-content" className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <motion.h1
            ...
            className="hero-title text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black leading-tight mb-6 md:mb-8"
          >
          ...
          <motion.p
            ...
            className="hero-subtitle text-base sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 md:mb-12 leading-relaxed px-2"
          >
            {c.subheadline}
          </motion.p>
